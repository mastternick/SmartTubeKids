...
public class SplashActivity extends MotherActivity implements SplashView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        com.liskovsoft.smartyoutubetv2.common.diag.DiagnosticProvider.crumb("SplashActivity.onCreate");
        ...
        com.liskovsoft.smartyoutubetv2.common.diag.DiagnosticProvider.crumb("SplashActivity: presenter initialized");
